sfneighb4comp <- function(w=38,x=12,y=24,z=18,d)
    {
        ...
        chart_title <- paste("Single-family Foreclosures over
 time in ",
        ...
        ggsave(filename = "/home/evan/Documents/chicago/dssg-landbank-project/analysis/foreclosure_graphs/sf_fourSample.pdf")
        return(p)
