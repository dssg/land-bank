...
var Dajaxice = {
    ...
    get_property_from_latlng: function(callback_function, argv, custom_settings){
        return Dajaxice.call('landbank_data.get_property_from_latlng', 'POST', callback_function, argv, custom_settings);
    },

    randomize: function(callback_function, argv, custom_settings){
        return Dajaxice.call('landbank_data.randomize', 'POST', callback_function, argv, custom_settings);
    }
