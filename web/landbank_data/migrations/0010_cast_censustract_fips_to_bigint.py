...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute('ALTER TABLE landbank_data_censustract ALTER COLUMN fips TYPE bigint USING (fips::bigint);')
        db.execute('ALTER TABLE landbank_data_summarystats ALTER COLUMN area_number TYPE bigint USING (area_number::bigint);')

    def backwards(self, orm):
        db.execute('ALTER TABLE landbank_data_censustract ALTER COLUMN fips TYPE varchar(20) USING (cast(fips as varchar(20));')
        db.execute('ALTER TABLE landbank_data_summarystats ALTER COLUMN area_number TYPE integer USING (area_number::integer);')
    ...
    models = {
        ...
        'landbank_data.summarystats': {
            ...
            'area_number': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
