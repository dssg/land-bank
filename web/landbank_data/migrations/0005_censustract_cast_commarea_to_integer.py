...
class Migration(SchemaMigration):
	...
	db.execute('ALTER TABLE landbank_data_censustract ALTER COLUMN commarea TYPE integer USING (commarea::integer)')

    def backwards(self, orm):
	db.execute('ALTER TABLE landbank_data_censustract ALTER COLUMN commarea TYPE varchar(2)')
