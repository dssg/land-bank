...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CensusTractIncome.med_house_txn_2011'
        db.add_column(u'landbank_data_censustractincome', 'med_house_txn_2011',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CensusTractIncome.med_house_txn_2011'
        db.delete_column(u'landbank_data_censustractincome', 'med_house_txn_2011')
