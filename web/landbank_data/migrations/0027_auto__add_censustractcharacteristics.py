...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CensusTractCharacteristics'
        db.create_table(u'landbank_data_censustractcharacteristics', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fips', self.gf('django.db.models.fields.BigIntegerField')()),
            ('pop', self.gf('django.db.models.fields.IntegerField')()),
            ('median_age', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('pct_18plus', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('pct_65plus', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('pct_whitenh', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('pct_blacknh', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('pct_asiannh', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('pct_hispanic', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('housing_units', self.gf('django.db.models.fields.IntegerField')()),
            ('pct_occ_units', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('pct_vac_units', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('pct_vac_owner', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('pct_vac_rental', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('pct_owner_occupied', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('owner_occ_hh_size', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('pct_renter_occupied', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('renter_occ_hh_size', self.gf('django.db.models.fields.FloatField')(null=True)),
        ))
        db.send_create_signal('landbank_data', ['CensusTractCharacteristics'])


    def backwards(self, orm):
        # Deleting model 'CensusTractCharacteristics'
        db.delete_table(u'landbank_data_censustractcharacteristics')
