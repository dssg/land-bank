...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'landbank_data.ward', (
            ...
            ('alderman', self.gf('django.db.models.fields.CharField')(max_length=60, null=True)),
            ('ward_class', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('ward_phone', self.gf('django.db.models.fields.CharField')(max_length=12, null=True)),
            ('hall_phone', self.gf('django.db.models.fields.CharField')(max_length=12, null=True)),
            ('hall_office', self.gf('django.db.models.fields.CharField')(max_length=45, null=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=39, null=True)),
            ('edit_date', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
        ...
        # Adding field 'SummaryStats.bldg_sqft_avg'
        db.add_column(u'landbank_data_summarystats', 'bldg_sqft_avg',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'SummaryStats.land_sqft_avg'
        db.add_column(u'landbank_data_summarystats', 'land_sqft_avg',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'SummaryStats.ppsf_avg'
        db.add_column(u'landbank_data_summarystats', 'ppsf_avg',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SummaryStats.bldg_sqft_avg'
        db.delete_column(u'landbank_data_summarystats', 'bldg_sqft_avg')

        # Deleting field 'SummaryStats.land_sqft_avg'
        db.delete_column(u'landbank_data_summarystats', 'land_sqft_avg')

        # Deleting field 'SummaryStats.ppsf_avg'
        db.delete_column(u'landbank_data_summarystats', 'ppsf_avg')
