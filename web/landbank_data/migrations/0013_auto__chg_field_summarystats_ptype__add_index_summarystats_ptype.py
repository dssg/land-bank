...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'SummaryStats.ptype' to match new field type.
        db.rename_column(u'landbank_data_summarystats', 'ptype', 'ptype_id')
        # Changing field 'SummaryStats.ptype'
        db.alter_column(u'landbank_data_summarystats', 'ptype_id', self.gf('django.db.models.fields.related.ForeignKey')(default=6, to=orm['landbank_data.PropertyTypes']))
        # Adding index on 'SummaryStats', fields ['ptype']
        db.create_index(u'landbank_data_summarystats', ['ptype_id'])


    def backwards(self, orm):
        # Removing index on 'SummaryStats', fields ['ptype']
        db.delete_index(u'landbank_data_summarystats', ['ptype_id'])


        # Renaming column for 'SummaryStats.ptype' to match new field type.
        db.rename_column(u'landbank_data_summarystats', 'ptype_id', 'ptype')
        # Changing field 'SummaryStats.ptype'
        db.alter_column(u'landbank_data_summarystats', 'ptype', self.gf('django.db.models.fields.IntegerField')(null=True))
