...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'landbank_data_buildingpermit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('permit_number', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('permit_type', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal('landbank_data', ['BuildingPermit'])

        # Adding model 'CensusBlockEmployment'
        db.create_table(u'landbank_data_censusblockemployment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fips', self.gf('django.db.models.fields.BigIntegerField')()),
            ('censusblock', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.CensusBlock'])),
            ('jobs', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('landbank_data', ['CensusBlockEmployment'])

        # Adding model 'BusinessLicense'
        db.create_table(u'landbank_data_businesslicense', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('license_number', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('legal_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('dba_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('descr', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('loc', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=3435, null=True)),
        ))
        db.send_create_signal('landbank_data', ['BusinessLicense'])

        # Adding field 'IndicatorCache.indicator_date'
        db.add_column(u'landbank_data_indicatorcache', 'indicator_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)

        # Adding index on 'IndicatorCache', fields ['area_id']
        db.create_index(u'landbank_data_indicatorcache', ['area_id'])

        # Adding index on 'IndicatorCache', fields ['area_type']
        db.create_index(u'landbank_data_indicatorcache', ['area_type'])

        # Adding index on 'IndicatorCache', fields ['indicator_name']
        db.create_index(u'landbank_data_indicatorcache', ['indicator_name'])


    def backwards(self, orm):
        # Removing index on 'IndicatorCache', fields ['indicator_name']
        db.delete_index(u'landbank_data_indicatorcache', ['indicator_name'])

        # Removing index on 'IndicatorCache', fields ['area_type']
        db.delete_index(u'landbank_data_indicatorcache', ['area_type'])

        # Removing index on 'IndicatorCache', fields ['area_id']
        db.delete_index(u'landbank_data_indicatorcache', ['area_id'])

        # Deleting model 'BuildingPermit'
        db.delete_table(u'landbank_data_buildingpermit')

        # Deleting model 'CensusBlockEmployment'
        db.delete_table(u'landbank_data_censusblockemployment')

        # Deleting model 'BusinessLicense'
        db.delete_table(u'landbank_data_businesslicense')

        # Deleting field 'IndicatorCache.indicator_date'
        db.delete_column(u'landbank_data_indicatorcache', 'indicator_date')
    ...
    models = {
        ...
        'landbank_data.buildingpermit': {
            'Meta': {'object_name': 'BuildingPermit'},
            'cost': ('django.db.models.fields.FloatField', [], {}),
            'descr': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loc': ('django.contrib.gis.db.models.fields.PointField', [], {'srid': '3435', 'null': 'True'}),
            'permit_number': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            'permit_type': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'pin': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
        'landbank_data.businesslicense': {
            'Meta': {'object_name': 'BusinessLicense'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'dba_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'descr': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'legal_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'license_number': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            'loc': ('django.contrib.gis.db.models.fields.PointField', [], {'srid': '3435', 'null': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
        ...
        'landbank_data.censusblock': {
            'Meta': {'object_name': 'CensusBlock'},
            'fips': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loc': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'srid': '3435'})
        },
        'landbank_data.censusblockemployment': {
            'Meta': {'object_name': 'CensusBlockEmployment'},
            'censusblock': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['landbank_data.CensusBlock']"}),
            'fips': ('django.db.models.fields.BigIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jobs': ('django.db.models.fields.IntegerField', [], {})
        },
        'landbank_data.censusblockpopulation': {
            'Meta': {'object_name': 'CensusBlockPopulation'},
            'fips': ('django.db.models.fields.BigIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'landbank_data.censustractcharacteristics': {
            'Meta': {'object_name': 'CensusTractCharacteristics'},
            'fips': ('django.db.models.fields.BigIntegerField', [], {}),
            'housing_units': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'median_age': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'owner_occ_hh_size': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_18plus': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_65plus': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_asiannh': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_blacknh': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_hispanic': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_occ_units': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_owner_occupied': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_renter_occupied': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_vac_owner': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_vac_rental': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_vac_units': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pct_whitenh': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'pop': ('django.db.models.fields.IntegerField', [], {}),
            'renter_occ_hh_size': ('django.db.models.fields.FloatField', [], {'null': 'True'})
        },
        'landbank_data.censustractincome': {
            'Meta': {'object_name': 'CensusTractIncome'},
            'fips': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inc_100_150': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'inc_10_15': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'inc_150_200': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'inc_15_25': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'inc_25_35': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'inc_35_50': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'inc_50_75': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'inc_75_100': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'inc_gt_200': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'inc_lt_10': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'med_house_txn_2011': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'med_inc': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
        'landbank_data.censustractmapping': {
            'Meta': {'object_name': 'CensusTractMapping'},
            'censustract': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['landbank_data.CensusTract']"}),
            'characteristics': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['landbank_data.CensusTractCharacteristics']"}),
            'communityarea': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['landbank_data.CommunityArea']", 'null': 'True'}),
            'communityarea_frac': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'fips': ('django.db.models.fields.BigIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'income': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['landbank_data.CensusTractIncome']"}),
            'municipality': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['landbank_data.Municipality']", 'null': 'True'}),
            'municipality_frac': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'ward': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['landbank_data.Ward']", 'null': 'True'}),
            'ward_frac': ('django.db.models.fields.FloatField', [], {'null': 'True'})
        },
        ...
        'landbank_data.indicatorcache': {
            'Meta': {'object_name': 'IndicatorCache'},
            'area_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'db_index': 'True'}),
            'area_type': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indicator_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
            'indicator_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),
            'indicator_value': ('django.db.models.fields.FloatField', [], {})
        },
        ...
        'landbank_data.pinarealookup': {
            ...
            'community_area': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['landbank_data.CommunityArea']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pin': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'ward': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['landbank_data.Ward']", 'null': 'True'})
        },
        'landbank_data.population': {
            'Meta': {'object_name': 'Population', 'db_table': "'population'", 'managed': 'False'},
            'area_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'area_type': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pop': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        'landbank_data.tractscores': {
            ...
            'affordability': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'vacancy': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
