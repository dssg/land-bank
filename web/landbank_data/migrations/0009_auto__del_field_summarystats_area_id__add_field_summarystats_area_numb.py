...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SummaryStats.area_id'
        db.delete_column(u'landbank_data_summarystats', 'area_id')

        # Adding field 'SummaryStats.area_number'
        db.add_column(u'landbank_data_summarystats', 'area_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SummaryStats.area_id'
        db.add_column(u'landbank_data_summarystats', 'area_id',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Deleting field 'SummaryStats.area_number'
        db.delete_column(u'landbank_data_summarystats', 'area_number')
