...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'landbank_data_pinarealookup', 'ward',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.Ward'], null=True),
                      keep_default=False)

        # Adding field 'PinAreaLookup.community_area'
        db.add_column(u'landbank_data_pinarealookup', 'community_area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.CommunityArea'], null=True),
                      keep_default=False)
