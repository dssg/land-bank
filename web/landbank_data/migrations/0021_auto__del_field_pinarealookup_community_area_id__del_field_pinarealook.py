...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PinAreaLookup.community_area_id'
        db.delete_column(u'landbank_data_pinarealookup', 'community_area_id_id')

        # Deleting field 'PinAreaLookup.census_tract_id'
        db.delete_column(u'landbank_data_pinarealookup', 'census_tract_id_id')

        # Deleting field 'PinAreaLookup.ward_id'
        db.delete_column(u'landbank_data_pinarealookup', 'ward_id_id')

        # Adding field 'PinAreaLookup.ward'
        db.add_column(u'landbank_data_pinarealookup', 'ward',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.Wards'], null=True),
                      keep_default=False)

        # Adding field 'PinAreaLookup.community_area'
        db.add_column(u'landbank_data_pinarealookup', 'community_area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.CommunityAreas'], null=True),
                      keep_default=False)

        # Adding field 'PinAreaLookup.census_tract'
        db.add_column(u'landbank_data_pinarealookup', 'census_tract',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.CensusTract'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PinAreaLookup.community_area_id'
        db.add_column(u'landbank_data_pinarealookup', 'community_area_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.CommunityAreas'], null=True),
                      keep_default=False)

        # Adding field 'PinAreaLookup.census_tract_id'
        db.add_column(u'landbank_data_pinarealookup', 'census_tract_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.CensusTract'], null=True),
                      keep_default=False)

        # Adding field 'PinAreaLookup.ward_id'
        db.add_column(u'landbank_data_pinarealookup', 'ward_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.Wards'], null=True),
                      keep_default=False)

        # Deleting field 'PinAreaLookup.ward'
        db.delete_column(u'landbank_data_pinarealookup', 'ward_id')

        # Deleting field 'PinAreaLookup.community_area'
        db.delete_column(u'landbank_data_pinarealookup', 'community_area_id')

        # Deleting field 'PinAreaLookup.census_tract'
        db.delete_column(u'landbank_data_pinarealookup', 'census_tract_id')
