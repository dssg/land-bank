...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TractScores.vacancy'
        db.add_column(u'landbank_data_tractscores', 'vacancy',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TractScores.vacancy'
        db.delete_column(u'landbank_data_tractscores', 'vacancy')
