...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CensusBlock'
        db.create_table(u'landbank_data_censusblock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fips', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('loc', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3435)),
        ))
        db.send_create_signal('landbank_data', ['CensusBlock'])

        # Adding model 'CensusTractMapping'
        db.create_table(u'landbank_data_censustractmapping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fips', self.gf('django.db.models.fields.BigIntegerField')()),
            ('censustract', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.CensusTract'])),
            ('municipality', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.Municipality'], null=True)),
            ('municipality_frac', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('communityarea', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.CommunityArea'], null=True)),
            ('communityarea_frac', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('ward', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.Ward'], null=True)),
            ('ward_frac', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('characteristics', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.CensusTractCharacteristics'])),
            ('income', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landbank_data.CensusTractIncome'])),
        ))
        db.send_create_signal('landbank_data', ['CensusTractMapping'])

        # Adding model 'CensusBlockPopulation'
        db.create_table(u'landbank_data_censusblockpopulation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fips', self.gf('django.db.models.fields.BigIntegerField')()),
            ('pop', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('landbank_data', ['CensusBlockPopulation'])

        # Adding model 'Municipality'
        db.create_table(u'landbank_data_municipality', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('landbank_data', ['Municipality'])

        # Adding model 'IndicatorCache'
        db.create_table(u'landbank_data_indicatorcache', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area_type', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('area_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('indicator_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('indicator_value', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('landbank_data', ['IndicatorCache'])


    def backwards(self, orm):
        # Deleting model 'CensusBlock'
        db.delete_table(u'landbank_data_censusblock')

        # Deleting model 'CensusTractMapping'
        db.delete_table(u'landbank_data_censustractmapping')

        # Deleting model 'CensusBlockPopulation'
        db.delete_table(u'landbank_data_censusblockpopulation')

        # Deleting model 'Municipality'
        db.delete_table(u'landbank_data_municipality')

        # Deleting model 'IndicatorCache'
        db.delete_table(u'landbank_data_indicatorcache')
    ...
    models = {
        ...
        'landbank_data.indicatorcache': {
            ...
            'area_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'area_type': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indicator_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
