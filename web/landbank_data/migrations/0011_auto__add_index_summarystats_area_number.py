...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SummaryStats', fields ['area_number']
        db.create_index(u'landbank_data_summarystats', ['area_number'])


    def backwards(self, orm):
        # Removing index on 'SummaryStats', fields ['area_number']
        db.delete_index(u'landbank_data_summarystats', ['area_number'])
