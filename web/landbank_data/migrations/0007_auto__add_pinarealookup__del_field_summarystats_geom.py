...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PinAreaLookup'
        db.create_table(u'landbank_data_pinarealookup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pin', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('ward_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('community_area_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('census_tract_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('landbank_data', ['PinAreaLookup'])

        # Deleting field 'SummaryStats.geom'
        db.delete_column(u'landbank_data_summarystats', 'geom')


    def backwards(self, orm):
        # Deleting model 'PinAreaLookup'
        db.delete_table(u'landbank_data_pinarealookup')

        # Adding field 'SummaryStats.geom'
        db.add_column(u'landbank_data_summarystats', 'geom',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3435, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'landbank_data.pinarealookup': {
            ...
            'census_tract_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'community_area_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pin': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            'ward_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
