...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PinAreaLookup', fields ['ward_id']
        db.create_index(u'landbank_data_pinarealookup', ['ward_id'])

        # Adding index on 'PinAreaLookup', fields ['community_area_id']
        db.create_index(u'landbank_data_pinarealookup', ['community_area_id'])

        # Adding index on 'PinAreaLookup', fields ['pin']
        db.create_index(u'landbank_data_pinarealookup', ['pin'])

        # Adding index on 'PinAreaLookup', fields ['census_tract_id']
        db.create_index(u'landbank_data_pinarealookup', ['census_tract_id'])


    def backwards(self, orm):
        # Removing index on 'PinAreaLookup', fields ['census_tract_id']
        db.delete_index(u'landbank_data_pinarealookup', ['census_tract_id'])

        # Removing index on 'PinAreaLookup', fields ['pin']
        db.delete_index(u'landbank_data_pinarealookup', ['pin'])

        # Removing index on 'PinAreaLookup', fields ['community_area_id']
        db.delete_index(u'landbank_data_pinarealookup', ['community_area_id'])

        # Removing index on 'PinAreaLookup', fields ['ward_id']
        db.delete_index(u'landbank_data_pinarealookup', ['ward_id'])
