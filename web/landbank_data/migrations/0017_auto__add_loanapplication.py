...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LoanApplication'
        db.create_table(u'landbank_data_loanapplication', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('respondent_id', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('agency_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('loan_type', self.gf('django.db.models.fields.IntegerField')(max_length=12, null=True)),
            ('property_type', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('loan_purpose', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('owner_occ', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('loan_amt', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('preapproval_req', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('action_type', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('fips', self.gf('django.db.models.fields.BigIntegerField')(null=True)),
            ('applicant_income', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('purchaser_type', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('denial_reason1', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('denial_reason2', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('denial_reason3', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('rate_spread', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('hoepa_status', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('lien_status', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('population', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('minority_pop_pct', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('med_fam_inc', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('tract_msa_md_inc', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('num_owner_occ', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('num_1_4', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('landbank_data', ['LoanApplication'])


    def backwards(self, orm):
        # Deleting model 'LoanApplication'
        db.delete_table(u'landbank_data_loanapplication')
