...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CmapPlan'
        db.create_table(u'landbank_data_cmapplan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('study_area', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('short_descr', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('loc', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3435)),
        ))
        db.send_create_signal('landbank_data', ['CmapPlan'])

        # Adding model 'Brownfield'
        db.create_table(u'landbank_data_brownfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pin', self.gf('django.db.models.fields.CharField')(max_length=14, null=True)),
            ('recipient', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('agreementno', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('granttype', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('fundingtype', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('acresid', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('loc', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=3435, null=True)),
        ))
        db.send_create_signal('landbank_data', ['Brownfield'])

        # Adding model 'CrimeIncident'
        db.create_table(u'landbank_data_crimeincident', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('crimeid', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ...
            ('iucr', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ...
            ('locdescr', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ...
            ('beat', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('commarea', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('fbicode', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('loc', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=3435, null=True)),
        ))
        db.send_create_signal('landbank_data', ['CrimeIncident'])


    def backwards(self, orm):
        # Deleting model 'CmapPlan'
        db.delete_table(u'landbank_data_cmapplan')

        # Deleting model 'Brownfield'
        db.delete_table(u'landbank_data_brownfield')

        # Deleting model 'CrimeIncident'
        db.delete_table(u'landbank_data_crimeincident')
