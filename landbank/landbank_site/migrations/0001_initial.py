...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'landbank_site_auction', (
        ...
        db.send_create_signal('landbank_site', ['Auction'])

        # Adding model 'CashFin'
        db.create_table(u'landbank_site_cashfin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pin', self.gf('django.db.models.fields.FloatField')(db_index=True)),
            ('doc', self.gf('django.db.models.fields.CharField')(max_length=16, null=True)),
            ('date_doc', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ...
        db.send_create_signal('landbank_site', ['CashFin'])

        # Adding model 'Foreclosure'
        db.create_table(u'landbank_site_foreclosure', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pin', self.gf('django.db.models.fields.FloatField')(db_index=True)),
        ...
        db.send_create_signal('landbank_site', ['Foreclosure'])

        # Adding model 'Mortgage'
        db.create_table(u'landbank_site_mortgage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pin', self.gf('django.db.models.fields.FloatField')(db_index=True)),
        ...
        db.send_create_signal('landbank_site', ['Mortgage'])

        # Adding model 'Transaction'
        db.create_table(u'landbank_site_transaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pin', self.gf('django.db.models.fields.FloatField')(db_index=True)),
            ('amount_prime', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('doc', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
        ...
        db.send_create_signal('landbank_site', ['Transaction'])


    def backwards(self, orm):
        # Deleting model 'Auction'
        db.delete_table(u'landbank_site_auction')

        # Deleting model 'CashFin'
        db.delete_table(u'landbank_site_cashfin')

        # Deleting model 'Foreclosure'
        db.delete_table(u'landbank_site_foreclosure')

        # Deleting model 'Mortgage'
        db.delete_table(u'landbank_site_mortgage')

        # Deleting model 'Transaction'
        db.delete_table(u'landbank_site_transaction')
