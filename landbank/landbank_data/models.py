...
class Foreclosure(models.Model):
  ...
  plantiff      = models.CharField('Plantiff name', null=True, max_length=100)
  date_doc      = models.DateTimeField('Date documented', null=True)
  date_rec      = models.DateTimeField('Date recorded', null=True)
...
class Transaction(models.Model):
  ...
  non_condo	= models.NullBooleanField('Not a condo?', null=True) 
  purchase_less_20k = models.NullBooleanField('Low-value transaction?', null=True) 
  business_buyer = models.NullBooleanField('Buyer is a business?', null=True) 
  yq_doc        = models.IntegerField('Year and quarter recorded', null=True)
  yeard         = models.IntegerField('Year recorded', null=True)
  apt           = models.CharField('Apartment numer', max_length=10, null=True)
  direction     = models.CharField('Street direction', max_length=2, null=True)
...
class Assessor(models.Model):                                         
  ...
  class_description             = models.CharField('Building class description', max_length=250, null=True)
  ...
  type_pt_sf                    = models.NullBooleanField('Single-family?', null=True)
  type_pt_condo                 = models.NullBooleanField('Condo?', null=True)
  type_pt_2_4                   = models.NullBooleanField('2-4 unit building?', null=True)
